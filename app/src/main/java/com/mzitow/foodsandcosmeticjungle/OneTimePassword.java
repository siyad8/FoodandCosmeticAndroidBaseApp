        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(OneTimePassword.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    ...
                    Toast.makeText(OneTimePassword.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(OneTimePassword.this, ConsumerDashboard.class);
                            startActivity(i);
                            finish();
                        } else {
