 ...
 * Use the {@link Sweet#newInstance} factory method to
...
public class Sweet extends Fragment {
     ...
     * @return A new instance of fragment Sweet.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sweet = view.findViewById(R.id.my_sweetrecycler);
        sweet.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        CustomerFoodAdapter customerFoodAdapter = new CustomerFoodAdapter(foodProductEntities,getContext(),list);
       sweet.setAdapter(customerFoodAdapter);
