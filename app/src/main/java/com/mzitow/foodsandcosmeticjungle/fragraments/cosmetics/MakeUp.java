 ...
 * Use the {@link MakeUp#newInstance} factory method to
...
public class MakeUp extends Fragment {
     ...
     * @return A new instance of fragment MakeUp.
     */
    // TODO: Rename and change types and number of parameters
    public static MakeUp newInstance(String param1, String param2) {
        MakeUp fragment = new MakeUp();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        makeuprecyclerView = view.findViewById(R.id.my_MakeUprecycler);
        makeuprecyclerView.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        AddProductAdapter addProductAdapter = new AddProductAdapter(productEntities,getContext(),list);
        makeuprecyclerView.setAdapter(addProductAdapter);
//
