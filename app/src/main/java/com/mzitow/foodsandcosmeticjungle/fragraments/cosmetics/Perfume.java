package com.mzitow.foodsandcosmeticjungle.fragraments.cosmetics;
 ...
 * Use the {@link Perfume#newInstance} factory method to
...
public class Perfume extends Fragment {
     ...
     * @return A new instance of fragment Perfume.
     */
    // TODO: Rename and change types and number of parameters
    public static Perfume newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_perfume, container, false);
    }

    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        UserDatabase userDatabase1 = UserDatabase.getUserDatabase(getContext());
        List<WhatsNewEntity> whats = userDatabase1.whatsNewDao().getAllProductsList();
        whatsNewCategory = view.findViewById(R.id.my_newrecycler);
        whatsNewCategory.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        ...
        perfumerecyclerView = view.findViewById(R.id.my_Perfumerecycler);
        perfumerecyclerView.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        AddProductAdapter addProductAdapter = new AddProductAdapter(productEntities, getContext(),list);
        perfumerecyclerView.setAdapter(addProductAdapter);
